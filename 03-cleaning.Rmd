...
## US COVID Cases Data
US-state data is in csv format and we can read it directly into R. It contains cumulative COVID case numbers by states of each day. We transformed it to daily new cases per day for each state. For total us cases, we sumed up all states cases to get total cumulative cases and daily new cases per day. 
```{r}
